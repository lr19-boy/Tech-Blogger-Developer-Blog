              ...
              <div className="posts-list">
                {recentPosts.map(post => (
                  <div key={post.id} className="post-item">
                    <img src={resolveAvatar(post.author.avatar)} alt={post.author.name} className="author-avatar" style={{ width: 40, height: 40, objectFit: 'cover', borderRadius: '50%', marginRight: 12 }} />
                    <h4>{post.title}</h4>
